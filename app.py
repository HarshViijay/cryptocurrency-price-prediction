    ...
    if request.method == 'POST':
        ...
        if df['polarity'][0] > 0:   # Positive Sentiment
            if output == 1:
                ...
                prediction_text2='\n---------The Tweet sentiment is POSITIVE as it\'s polarity is {}'.format(df['polarity'][0])
                prediction_text3='\nSo Price will go up so it\'s a good time to sell.'
                combine = prediction_text1 + ' ' + prediction_text2 + ' ' + prediction_text3
                return render_template('index.html', prediction_text = combine)
            else:
                prediction_text1='Your Tweet is {}'.format(user)
                prediction_text2='\n---------The Tweet sentiment is POSITIVE as it\'s polarity is  {}'.format(df['polarity'][0])
                prediction_text3='\nBut Prediction says the Price will go down so it\'s a good time to buy more'
                combine = prediction_text1 + ' ' + prediction_text2 + ' ' + prediction_text3
                return render_template('index.html', prediction_text = combine)
            ...
            if output == 1:
                prediction_text1='Your Tweet is {}'.format(user)
                prediction_text2='\n---------The Tweet sentiment is NEGATIVE as it\'s polarity is {}'.format(df['polarity'][0])
                prediction_text3='\nBut Prediction says the Price will go up so it\'s a good time to sell.'
                combine = prediction_text1 + ' ' + prediction_text2 + ' ' + prediction_text3
                return render_template('index.html', prediction_text = combine)
            else:
                prediction_text1='Your Tweet is {}'.format(user)
                prediction_text2='\n---------The Tweet sentiment is NEGATIVE as it\'s polarity is  {}'.format(df['polarity'][0])
                prediction_text3='\nSo Price will go down so it\'s a good time to buy more'
                combine = prediction_text1 + ' ' + prediction_text2 + ' ' + prediction_text3
                return render_template('index.html', prediction_text = combine)
        else:    # Neutral Sentiment
            if output == 1:
                prediction_text1='Your Tweet is {}'.format(user)
                prediction_text2='\n---------The Tweet sentiment is NEUTRAL as it\'s polarity is {}'.format(df['polarity'][0])
                prediction_text3=' \nBut Prediction says the Price will go up so it\'s a good time to sell.'
                combine = prediction_text1 + ' ' + prediction_text2 + ' ' + prediction_text3
                return render_template('index.html', prediction_text = combine)
            else:
